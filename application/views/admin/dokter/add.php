                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_dokter" value="<?php echo $this->input->post('nama_dokter'); ?>" class="form-control" id="nama_dokter"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="id_poli" class="form-control">
                                                    ...
                                                    {
                                                        $selected = ($poli['id_poli'] == $this->input->post('id_poli')) ? ' selected="selected"' : "";
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="jk_dokter" class="form-control">
                                                    ...
                                                    {
                                                        $selected = ($value == $this->input->post('jk_dokter')) ? ' selected="selected"' : "";
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="ttl_dokter" value="<?php echo $this->input->post('ttl_dokter'); ?>" class="form-control" id="ttl_dokter"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="spesialis" value="<?php echo $this->input->post('spesial'); ?>" class="form-control" id="spesialis"
                                                placeholder="Masukkan Spesialis Dokter" />
			                                    <span class="text-danger"><?php echo form_error('spesial');?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
