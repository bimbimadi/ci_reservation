                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_dokter" class="form-control border-input" 
                                                value="<?php echo ($this->input->post('nama_dokter') ? $this->input->post('nama_dokter') : $dokter['nama_dokter']); ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="text-danger"><?php echo form_error('id_poli');?></span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="text-danger"><?php echo form_error('jk_dokter');?></span>
                                            </div>
                                            <div class="form-group">
                                                <label>Tanggal Lahir:</label>
                                                <input type="date" name="ttl_dokter" class="form-control border-input" 
                                                value="<?php echo ($this->input->post('ttl_dokter') ? $this->input->post('ttl_dokter') : $dokter['ttl_dokter']); ?>">
                                                <span class="text-danger"><?php echo form_error('ttl_dokter');?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                value="<?php echo ($this->input->post('no_telp') ? $this->input->post('no_telp') : $dokter['no_telp']); ?>">
                                                <span class="text-danger"><?php echo form_error('no_telp');?></span>
                                            </div>
                                            <div class="form-group">
                                                <label>Alamat:</label>
                                                <input type="text" name="alamat" class="form-control border-input" 
                                                value="<?php echo ($this->input->post('alamat') ? $this->input->post('alamat') : $dokter['alamat']); ?>">
                                                <span class="text-danger"><?php echo form_error('alamat');?></span>
                                            </div>
                                            <div class="form-group">
                                                <label>Spesialis:</label>
                                                <input type="text" name="spesialis" class="form-control border-input" 
                                                value="<?php echo ($this->input->post('spesialis') ? $this->input->post('spesialis') : $dokter['spesialis']); ?>">
