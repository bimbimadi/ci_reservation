                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama_poli" value="<?php echo $this->input->post('nama_poli'); ?>" class="form-control" id="nama_poli"
                                                placeholder="Masukkan Nama Poli" />
			                                    <span class="text-danger"><?php echo form_error('nama_poli');?></span>
                                            </div>
                                            <div class="form-group">
                                                <label>Lokasi:</label>
                                                <input type="text" placeholder="Masukkan Lokasi Poli" name="lokasi_poli" value="<?php echo $this->input->post('lokasi_poli'); ?>" class="form-control" id="lokasi_poli" />
